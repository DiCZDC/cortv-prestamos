...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ __('Bienvenid@') }} - {{ config('app.name', 'CORTV Prestamos') }}</title>
                    ...
                    @else
                        <div class="flex items-center gap-4">
                            ...
                            @if (Route::has('register'))
                                <a
                                    href="{{ route('register') }}"
                                    class="inline-flex justify-center gap-2 px-6 py-2 dark:text-[#EDEDEC] border rounded-lg leading-normal 
                                    font-medium bg-rojo-texto text-hueso
                                    hover:bg-transparent hover:border-2 hover:text-rojo-texto border-rojo-texto transition duration-300
                                    ease-in-out hover:translate-y-1.5 hover:shadow-sm">
                                    Registrate
                                    <flux:icon.user-round-plus />
                                </a>
                        </div>
