<div class="grid grid-cols-2 grid-rows-2 place-items-center content-center">
    ...
    <livewire:card titulo='Mantenimiento' descripcion='{{ $this->cant_mantenimiento ?? 0 }} equipos reportados necesitan revision' icono='wrench' color_bg='bg-rojo_oscuro' color_text='text-hueso'/>
